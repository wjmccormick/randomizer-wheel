(function () {
    ...
    */
    function getWheelPalette(wrapper) {
        var palette = String(wrapper.getAttribute('data-wheel-palette') || 'classic').trim().toLowerCase();
    ...
    function initWheel(wrapper) {
        ...
        */
        function rebuild() {
            ...
            drawWheel(canvas, items, getWheelPalette(wrapper));
        ...
        */
        function openPresentationMode() {
            ...
            drawWheel(presentationCanvas, items, getWheelPalette(wrapper));
