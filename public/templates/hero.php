...
?>
    ...
    <div id="<?php echo esc_attr($wheel_id); ?>" class="srw-hero-wrapper" style="<?php echo esc_attr($theme_style); ?>" data-wheel-palette="<?php echo esc_attr($wheel_palette); ?>" data-items="<?php echo esc_attr(wp_json_encode($demo_items)); ?>">
