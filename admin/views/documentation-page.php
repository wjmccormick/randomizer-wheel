...
$advanced_examples = [
    [
        'label' => 'Custom title',
        'description' => 'Adds a heading above the full wheel input panel.',
        'shortcode' => '[randomizer_wheel title="Prize Drawing"]',
    ],
    [
        'label' => 'Bourbon palette with accent color',
        'description' => 'Uses bourbon slice colors and a blue pointer/modal accent.',
        'shortcode' => '[randomizer_wheel wheel_palette="bourbon" accent_color="#00aaff"]',
    ],
    [
        'label' => 'Hidden presentation mode',
        'description' => 'Removes presentation mode controls for this wheel only.',
        'shortcode' => '[randomizer_wheel show_presentation="false"]',
    ],
    [
        'label' => 'Hidden remove-winner control',
        'description' => 'Keeps the winner modal and spin flow, but hides remove-winner controls.',
        'shortcode' => '[randomizer_wheel show_remove_winner="false"]',
    ],
    [
        'label' => 'Custom minimum entries',
        'description' => 'Requires at least three entries before visitors can spin.',
        'shortcode' => '[randomizer_wheel min_items="3"]',
    ],
    [
        'label' => 'Custom logo URL',
        'description' => 'Uses a custom center logo for this wheel instance.',
        'shortcode' => '[randomizer_wheel logo="https://example.com/logo.png" logo_alt="Example logo"]',
    ],
    [
        'label' => 'Hero wheel with muted palette',
        'description' => 'Applies the muted canvas palette to the hero/demo wheel.',
        'shortcode' => '[randomizer_wheel_hero wheel_palette="muted"]',
    ],
    [
        'label' => 'Hero wheel with custom CTA/link',
        'description' => 'Changes where the hero wheel links and the accessible CTA label.',
        'shortcode' => '[randomizer_wheel_hero link="/spin/" cta_text="Create your prize wheel"]',
    ],
];
?>
<div class="wrap rwp-docs-wrap">
    ...
    <section class="rwp-docs-card">
        <h2><?php echo esc_html('Common customization examples'); ?></h2>
        <p><?php echo esc_html('These examples combine common attributes. Each example affects only the wheel where the shortcode is placed.'); ?></p>
        <div class="rwp-advanced-examples">
            <?php foreach ($advanced_examples as $advanced_example) : ?>
                <div class="rwp-advanced-example">
                    <div class="rwp-advanced-example-copy">
                        <h3><?php echo esc_html($advanced_example['label']); ?></h3>
                        <p><?php echo esc_html($advanced_example['description']); ?></p>
                        <code><?php echo esc_html($advanced_example['shortcode']); ?></code>
                    </div>
                    <button type="button" class="button button-secondary rwp-copy-shortcode" data-shortcode="<?php echo esc_attr($advanced_example['shortcode']); ?>">
                        <?php echo esc_html('Copy shortcode'); ?>
                    </button>
                </div>
            <?php endforeach; ?>
    ...
    <section class="rwp-docs-card">
        ...
        <p class="description"><?php echo esc_html('These attributes can be added inside shortcode brackets to customize individual wheel instances.'); ?></p>
        <table class="widefat striped rwp-docs-table">
            <thead>
                <tr>
        ...
        <div class="rwp-palette-grid">
            <?php foreach (RWP_Settings::palette_options() as $palette_slug => $palette_label) : ?>
                <div class="rwp-palette-preview">
                    ...
                    <div class="rwp-palette-hexes" aria-hidden="true">
                        <?php foreach ($palette_previews[$palette_slug] as $color) : ?>
